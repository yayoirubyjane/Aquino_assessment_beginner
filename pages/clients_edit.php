...
<div class="wrapper py-5">
    <div class="d-flex flex-column justify-content-center align-items-center gap-3">
        ...
        <div class="card p-5 shadow-md rounded-5" style="width: 26rem;">
            <h2 style="font-weight: 600; text-align: center; color: #443A35;">Edit Client</h2>
            ...
            <form method="post" class="d-flex flex-column gap-3">
                <div>
                    ...
                    <input type="text" name="full_name" class="form-control w-100" value="<?php echo htmlspecialchars($client['full_name']); ?>">
                </div>
            
                <div>
                    <label class="form-label fw-bold mb-1">Email*</label>
                    <input type="email" name="email" class="form-control w-100" value="<?php echo htmlspecialchars($client['email']); ?>">
                </div>
            
                <div>
                    <label class="form-label fw-bold mb-1">Phone</label>
                    <input type="text" name="phone" class="form-control w-100" value="<?php echo htmlspecialchars($client['phone']); ?>">
                </div>
            
                <div>
                    <label class="form-label fw-bold mb-1">Address</label>
                    <input type="text" name="address" class="form-control w-100" value="<?php echo htmlspecialchars($client['address']); ?>">
                </div>
            
                <button type="submit" name="update" class="btn btn-dark mt-2" style="border-radius: 8px;">Update Client</button>
            </form>
        </div>
